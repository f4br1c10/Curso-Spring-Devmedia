...
public class CategoriaService {
	...
	public void saveOrUpdate(Categoria categoria) {
		...
		if (categoria.getId() != null) {
			Categoria cPersistence = repository.findOne(categoria.getId());
			cPersistence.setPermalink(permalink);
			cPersistence.setDescricao(categoria.getDescricao());
			repository.save(cPersistence);
		} else {
